...
#   filename:  workdir/storage_azure_upbound_io_v1beta1_accountlocaluser.yaml
...
class ResourceNameRef(BaseModel):
    name: str
    """
...
class ResourceNameSelector(BaseModel):
...
class PermissionScopeItem(BaseModel):
    ...
    """
    resourceNameRef: Optional[ResourceNameRef] = None
    """
    Reference to a Container in storage to populate resourceName.
    """
    resourceNameSelector: Optional[ResourceNameSelector] = None
    """
...
class SshAuthorizedKeyItem(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    permissionScope: Optional[List[PermissionScopeItem]] = None
    """
    One or more permission_scope blocks as defined below.
    """
    sshAuthorizedKey: Optional[List[SshAuthorizedKeyItem]] = None
    """
    One or more ssh_authorized_key blocks as defined below.
    """
    sshKeyEnabled: Optional[bool] = None
    """
    Specifies whether SSH Key Authentication is enabled. Defaults to false.
    """
    sshPasswordEnabled: Optional[bool] = None
    """
...
class PermissionScopeItemModel(BaseModel):
    permissions: Optional[List[Permission]] = None
    """
    A permissions block as defined below.
    """
...
class AtProvider(BaseModel):
    ...
    """
    permissionScope: Optional[List[PermissionScopeItemModel]] = None
    """
    One or more permission_scope blocks as defined below.
    """
    sshAuthorizedKey: Optional[List[SshAuthorizedKeyItem]] = None
...
class AccountLocalUser(BaseModel):
...
class AccountLocalUserList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[AccountLocalUser]
    """
    List of accountlocalusers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: Optional[str] = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
