...
#   filename:  workdir/storage_azure_upbound_io_v1beta1_datalakegen2path.yaml
...
class FilesystemNameRef(BaseModel):
    name: str
    """
...
class FilesystemNameSelector(BaseModel):
...
class ForProvider(BaseModel):
    ace: Optional[List[AceItem]] = None
    """
    One or more ace blocks as defined below to specify the entries for the ACL for the path.
    """
    filesystemName: Optional[str] = None
    """
    The name of the Data Lake Gen2 File System which should be created within the Storage Account. Must be unique within the storage account the queue is located. Changing this forces a new resource to be created.
    """
    filesystemNameRef: Optional[FilesystemNameRef] = None
    """
    Reference to a DataLakeGen2FileSystem in storage to populate filesystemName.
    """
    filesystemNameSelector: Optional[FilesystemNameSelector] = None
    """
...
class DataLakeGen2Path(BaseModel):
...
class DataLakeGen2PathList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[DataLakeGen2Path]
    """
    List of datalakegen2paths. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: Optional[str] = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
