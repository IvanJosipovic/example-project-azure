...
#   filename:  workdir/storage_azure_upbound_io_v1beta1_tableentity.yaml
...
class StorageTableIdRef(BaseModel):
    name: str
    """
    Name of the referenced object.
    """
...
class StorageTableIdSelector(BaseModel):
    matchControllerRef: Optional[bool] = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class TableNameSelector(BaseModel):
    matchControllerRef: Optional[bool] = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class ForProvider(BaseModel):
    ...
    """
    storageTableId: Optional[str] = None
    """
    The Storage Share ID in which this file will be placed into. Changing this forces a new resource to be created.
    """
    storageTableIdRef: Optional[StorageTableIdRef] = None
    """
    Reference to a Table in storage to populate storageTableId.
    """
    storageTableIdSelector: Optional[StorageTableIdSelector] = None
    """
    Selector for a Table in storage to populate storageTableId.
    """
    tableName: Optional[str] = None
    tableNameRef: Optional[TableNameRef] = None
    """
    Reference to a Table in storage to populate tableName.
    """
    tableNameSelector: Optional[TableNameSelector] = None
    """
...
class TableEntityList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[TableEntity]
    """
    List of tableentities. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: Optional[str] = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
