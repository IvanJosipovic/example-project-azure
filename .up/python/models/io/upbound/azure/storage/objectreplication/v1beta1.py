...
#   filename:  workdir/storage_azure_upbound_io_v1beta1_objectreplication.yaml
...
class DestinationStorageAccountIdRef(BaseModel):
    name: str
    """
...
class DestinationStorageAccountIdSelector(BaseModel):
...
class DestinationContainerNameRef(BaseModel):
    name: str
    """
    Name of the referenced object.
    """
...
class DestinationContainerNameSelector(BaseModel):
    matchControllerRef: Optional[bool] = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class SourceContainerNameRef(BaseModel):
    name: str
    """
    Name of the referenced object.
    """
...
class SourceContainerNameSelector(BaseModel):
    matchControllerRef: Optional[bool] = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class Rule(BaseModel):
    copyBlobsCreatedAfter: Optional[str] = None
    """
...
class SourceStorageAccountIdSelector(BaseModel):
    matchControllerRef: Optional[bool] = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class ForProvider(BaseModel):
    ...
    """
    sourceStorageAccountId: Optional[str] = None
    """
    The ID of the source storage account. Changing this forces a new Storage Object Replication to be created.
    """
    sourceStorageAccountIdRef: Optional[SourceStorageAccountIdRef] = None
    """
    Reference to a Account in storage to populate sourceStorageAccountId.
    """
    sourceStorageAccountIdSelector: Optional[SourceStorageAccountIdSelector] = None
    """
...
class AtProvider(BaseModel):
    destinationObjectReplicationId: Optional[str] = None
    """
    ...
    One or more rules blocks as defined below.
    """
    sourceObjectReplicationId: Optional[str] = None
    """
...
class ObjectReplication(BaseModel):
...
class ObjectReplicationList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[ObjectReplication]
    """
    List of objectreplications. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: Optional[str] = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
