...
#   filename:  workdir/storage_azure_upbound_io_v1beta1_sharedirectory.yaml
...
class ShareNameSelector(BaseModel):
...
class StorageShareIdRef(BaseModel):
    name: str
    """
    Name of the referenced object.
    """
...
class StorageShareIdSelector(BaseModel):
    matchControllerRef: Optional[bool] = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class ForProvider(BaseModel):
    ...
    The name (or path) of the Directory that should be created within this File Share. Changing this forces a new resource to be created.
    """
    shareNameRef: Optional[ShareNameRef] = None
    """
    Reference to a Share in storage to populate shareName.
    """
    shareNameSelector: Optional[ShareNameSelector] = None
    """
    ...
    """
    storageShareId: Optional[str] = None
    """
    The Storage Share ID in which this file will be placed into. Changing this forces a new resource to be created.
    """
    storageShareIdRef: Optional[StorageShareIdRef] = None
    """
    Reference to a Share in storage to populate storageShareId.
    """
    storageShareIdSelector: Optional[StorageShareIdSelector] = None
    """
...
class ShareDirectory(BaseModel):
...
class ShareDirectoryList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[ShareDirectory]
    """
    List of sharedirectories. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: Optional[str] = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
